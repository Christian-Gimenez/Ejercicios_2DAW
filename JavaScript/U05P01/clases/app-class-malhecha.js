...
function Tren(dia, horaSalida, asientos) {
  this.id = generarId(dia, horaSalida);
  this.asientos = asientos;

  function generarId(dia, horaSalida) {
    return dia.getDate() + horaSalida.replace(":", "");
  }
}

function Horario(idTren, horaSalida, diaObj) {
  this.id = idTren;
  this.horaSalida
  this.diaObj = diaObj;
}
